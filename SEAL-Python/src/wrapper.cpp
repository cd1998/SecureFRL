...
PYBIND11_MODULE(seal, m)
{
    ...
    py::enum_<encoding_method>(m, "encoding_method")
        .value("crt", encoding_method::crt)
        .value("pm", encoding_method::pm);
    ...
    py::class_<EncryptionParameters>(m, "EncryptionParameters")
        ...
        .def("set_encoding_method", &EncryptionParameters::set_encoding_method)
        .def("scheme", &EncryptionParameters::scheme)
        .def("encodmd", &EncryptionParameters::encodmd)
