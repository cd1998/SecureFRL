...
namespace seal
{
    ...
    */
    ...
    /**
    Describes the type of encoding method to be used.
    */
    enum class encoding_method : std::uint8_t
    {	
    ...
    */
    ...
    public:
        ...
        */
        ...
        @param[in] random_generator Pointer to the random generator factory
        */
        inline void set_encoding_method(encoding_method method) noexcept
        {
            encmd_ = method;
            compute_parms_id();
        }
        ...
        */
        ...
        Returns the encryption scheme type.
        */
        SEAL_NODISCARD inline encoding_method encodmd() const noexcept
        {
            return encmd_;
        }
    ...
    private:
        ...
        */
        ...
        encoding_method encmd_ = encoding_method::crt;		
