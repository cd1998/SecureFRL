    ...
    */
    ...
    public:
        ...
        */
        ...
        //void encodepm1(const std::vector<std::uint64_t> &values, Plaintext &destination) const;
        //void encodepm2(const std::vector<std::uint64_t> &values, Plaintext &destination) const;
        ...
        */
        ...
        //void encodepm1(const std::vector<std::int64_t> &values, Plaintext &destination) const;
        //void encodepm2(const std::vector<std::int64_t> &values, Plaintext &destination) const;
#ifdef SEAL_USE_MSGSL
        /**
        Creates a plaintext from a given matrix. This function "batches" a given matrix
        of integers modulo the plaintext modulus into a plaintext element, and stores
        ...
        */
        ...
        //void encodepm1(gsl::span<const std::uint64_t> values, Plaintext &destination) const;
        //void encodepm2(gsl::span<const std::uint64_t> values, Plaintext &destination) const;
        ...
        */
        ...
        //void encodepm1(gsl::span<const std::int64_t> values, Plaintext &destination) const;
        //void encodepm2(gsl::span<const std::int64_t> values, Plaintext &destination) const;
#endif
        /**
